...
const PROVIDERS = [
  { 
    ...
    name: 'OpenAI', 
    models: [
      { id: 'gpt-4o', name: 'GPT-4o + Web Search', description: 'الأفضل للبحث في الويب (Responses API)', recommended: true, webSearch: true },
      { id: 'gpt-4o-search-preview', name: 'GPT-4o Search Preview', description: 'موديل متخصص للبحث في الويب', webSearch: true },
      { id: 'gpt-4o-mini-search-preview', name: 'GPT-4o Mini Search', description: 'بحث سريع وأرخص', webSearch: true },
      { id: 'gpt-5.2', name: 'GPT-5.2 Thinking', description: 'تحليل عميق مع reasoning_effort + بحث ويب', webSearch: true },
      { id: 'gpt-5.1', name: 'GPT-5.1 Thinking', description: 'الجيل السابق مع بحث ويب', webSearch: true },
      { id: 'gpt-4-turbo', name: 'GPT-4 Turbo', description: 'موديل قديم مستقر (بدون بحث ويب)', webSearch: false },
      { id: 'o1', name: 'o1 Reasoning', description: 'تفكير عميق للمهام المعقدة', webSearch: false },
      { id: 'o3-mini', name: 'o3 Mini', description: 'تفكير سريع وفعال', webSearch: false },
    ] 
  },
